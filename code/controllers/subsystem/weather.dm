...
/datum/controller/subsystem/weather/fire()
	...
	for(var/z in eligible_zlevels)
		...
		next_hit_by_zlevel["[z]"] = addtimer(CALLBACK(src, TYPE_PROC_REF(/datum/controller/subsystem/weather, make_eligible), z, possible_weather), randTime + initial(W.weather_duration_upper), TIMER_UNIQUE|TIMER_STOPPABLE) //Around 5-10 minutes between weathers
