...
/obj/effect/spawner/random/equipment/atmospherics/canister
	name = "random canister"
	icon = 'icons/effects/landmarks_static.dmi'
	icon_state = "random_canister"
	alpha = 128

/obj/effect/spawner/random/equipment/atmospherics/canister/item_to_spawn()
...
/obj/effect/spawner/random/equipment/atmospherics/canister/low_chance
	name = "low chance random canister"
	spawn_nothing_percentage = 60

/obj/effect/spawner/random/equipment/atmospherics/canister/dangerous
