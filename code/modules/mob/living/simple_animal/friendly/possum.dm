/mob/living/simple_animal/opossum
	...
	speak = list("Hiss!","HISS!","Hissss?", "aaaaaaa", "Aaa!")
	speak_emote = list("hisses", "screams quietly")
	emote_hear = list("hisses.")
	emote_see = list("trundles in a circle.", "shakes.")
	speak_chance = 1
	turns_per_move = 3
	blood_volume = 250
	see_in_dark = 5
...
/mob/living/simple_animal/opossum/poppy
	...
	pet_bonus = TRUE
	pet_bonus_emote = "bleps nervously!"
