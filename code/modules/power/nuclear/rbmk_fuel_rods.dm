/obj/item/fuel_rod
	...
	icon = 'icons/obj/machines/reactor/control_rod.dmi'
...
/obj/item/fuel_rod/material/bananium/depletion_final(result_rod)
	...
	if(!result_rod)
		...
		desc = "A hilarious heavy-duty fuel rod which fissiles a bit slower than its cowardly counterparts. Its greatly grimacing growth stage is now over, and bananium outgrowth hums as if it's blatantly honking bike horns."
