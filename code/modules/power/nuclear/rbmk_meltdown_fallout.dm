/obj/effect/decal/nuclear_waste
	...
	icon = 'icons/obj/machines/reactor/reactor_parts.dmi'
...
/datum/weather/nuclear_fallout
	...
	weather_sound = 'sound/machines/reactor/falloutwind.ogg'
	end_duration = 100
	area_type = /area
	protected_areas = list(/area/station/maintenance, /area/ai_monitored/turret_protected/ai_upload, /area/ai_monitored/turret_protected/ai_upload_foyer,
	/area/ai_monitored/turret_protected/ai, /area/station/storage/emergency/starboard, /area/station/storage/emergency/port, /area/shuttle)
