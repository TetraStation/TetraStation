...
/obj/machinery/computer/reactor/fuel_rods/attack_hand(mob/living/user)
	...
	if(!fuel_rod)
		return
	playsound(src, pick('sound/machines/reactor/switch.ogg','sound/machines/reactor/switch2.ogg','sound/machines/reactor/switch3.ogg'), 100, FALSE)
	playsound(reactor, 'sound/machines/reactor/crane_1.ogg', 100, FALSE)
...
/obj/machinery/computer/reactor/pump/attack_hand(mob/living/user)
	...
	if(!is_operational)
		return FALSE
	playsound(loc, pick('sound/machines/reactor/switch.ogg','sound/machines/reactor/switch2.ogg','sound/machines/reactor/switch3.ogg'), 100, FALSE)
