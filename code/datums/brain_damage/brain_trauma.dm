...
/datum/brain_trauma/proc/on_gain()
	...
	RegisterSignal(owner, COMSIG_MOB_SAY, TYPE_PROC_REF(/datum/brain_trauma, handle_speech))
	RegisterSignal(owner, COMSIG_MOVABLE_HEAR, TYPE_PROC_REF(/datum/brain_trauma, handle_hearing))
