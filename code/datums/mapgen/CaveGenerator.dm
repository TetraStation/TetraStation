/datum/map_generator/cave_generator
	...
	var/closed_turf_types =  list(/turf/closed/mineral = 1)


	///Weighted list of extra features that can spawn in the area, such as geysers.
	var/list/feature_spawn_list = list(/obj/structure/geyser/random = 1)
	///Weighted list of mobs that can spawn in the area.
	var/list/mob_spawn_list = list(/mob/living/simple_animal/hostile/asteroid/goliath = 50, /mob/living/simple_animal/hostile/asteroid/basilisk = 3, \
		/mob/living/simple_animal/hostile/asteroid/hivelord = 40, /mob/living/simple_animal/hostile/asteroid/goldgrub = 10) // No megafauna've been made for asteroids. Yet.
	///Weighted list of flora that can spawn in the area.
	var/list/flora_spawn_list = list(/obj/structure/flora/rock = 2 , /obj/structure/flora/rock/pile = 2)
